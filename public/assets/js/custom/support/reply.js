$(function(){
    ...
    const addToList=(avatarAdmin, nameAdmin, content, time, images)=>{
            ...
            <div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
                <div class="d-flex align-items-center">
                    <div class="symbol symbol-50 me-4">
                        <span class="symbol-label" style="background-image:url(${host}/assets/media/avatars/${ avatarAdmin.replace(' ', '%20',) });"></span>
                    </div>
                    <div class="pe-5">
