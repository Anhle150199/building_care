            ...
            S = function (e) {
                if (
                    ...
                    !0 === I(e, "expand")
                        ...
                        !1 === i && x(e),
                        !0 === KTUtil.data(e).has("popper") && E(e),
        ...
        var i = { saveState: !0 },
            ...
            a = function () {
                ...
                !1 === n.element.hasAttribute("data-kt-scroll-activate")
                    ? ((e = f()),
                      ...
                      l(),
                      !0 === m("save-state") && void 0 !== KTCookie && n.id
                ...
                if (null !== e) {
                    ...
                    if (t && 2 == t.length) {
                        var i = t[0],
                            ...
                            o = d(r) - d(i);
                        if (o > 0) {
                            var a = parseInt(KTUtil.css(n.element, f())) + o;
                            KTUtil.css(n.element, f(), String(a) + "px");
                        }
                    }
                }
            },
            ...
            u = function () {
                var e,
                    ...
                    o = m("offset");
                if (
                    ((t -= c(n.element)), null !== i) &&
                    (e = document.querySelectorAll(i)) &&
                    e.length > 0
                )
                    for (var a = 0, l = e.length; a < l; a++)
                        !1 !== KTUtil.visible(e[a]) && (t -= d(e[a]));
                if (
                    null !== r &&
                    ...
                    !0 === u
                        ? (t > o && (0 === a || a < r)
                              ? (!1 === i.hasAttribute(n.attributeName) &&
                                    ...
                                    i.setAttribute(n.attributeName2, "on")),
                              ...
                              : (!0 === i.hasAttribute(n.attributeName) &&
                                    ...
                                    i.removeAttribute(n.attributeName2)),
            ...
            l = function (e) {
                ...
                if (
                    (!0 !== e &&
                        ...
                        KTUtil.animateClass(
                            n.element,
                            "animation " + d("animationClass")
                        )),
                    null !== s && KTUtil.addClass(n.element, s),
                    null !== a &&
                ...
                if (null !== i)
                    if ("auto" === String(i).toLowerCase()) {
                        ...
                        f > 0 &&
                            KTUtil.css(n.element, "left", String(f) + "px");
                ...
                if (
                    ...
                    if (p && p.length > 0)
                        for (var g = 0, v = p.length; g < v; g++)
                            KTUtil.css(p[g], "padding-top", String(c) + "px");
                }
            },
            s = function () {
    ...
    return {
        ...
        initBootstrapModal: function () {
            -1 !== navigator.userAgent.toLowerCase().indexOf("firefox") &&
                document
                    .querySelectorAll(".modal:not(.initialized)")
                    .forEach((e) => {
                ...
                var n = function (e, t) {
                    return new Promise(function (n, i) {
                        ...
                        (o.rel = "stylesheet"),
                            (o.type = "text/css"),
                            (o.href = a),
                            document.head.insertBefore(o, r),
                            (o.onload = function () {
                                n(a), r.remove();
                            }),
                            (o.onerror = function () {
                ...
                document.body.classList.add("page-loading"),
                    "dark" === e
                        ? Promise.all([
                              ...
                              n("style.bundle.css", "style.dark.bundle.css"),
                          ])
                              .then(function () {
                        ...
                        : "light" === e &&
                          Promise.all([
                              ...
                              n("style.dark.bundle.css", "style.bundle.css"),
                          ])
                              .then(function () {
