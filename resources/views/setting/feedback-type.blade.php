...
@endpush
@section('title', 'Thể loại phản hồi')
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            data-route-delete="{{ route('admin.system.feedback-type.delete') }}"
            data-route-edit = "{{ route('admin.system.feedback-type.edit') }}"
            data-route-new = "{{ route('admin.system.feedback-type.new') }}">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}"
                    class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Thể loại phản hồi</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">Thể loại phản hồi</li>
                    </ul>
                </div>
            </div>
        </div>
