...
@push('css')
    <link href="{{ url('/') }}/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet"
        type="text/css" />
@endpush
@section('title', 'Danh sách tài khoản cư dân')
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Danh sách cư dân</h1>
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">Quản lý cư dân</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Tìm kiếm" />
                        </div>
                    </div>
                    {{-- Bộ lọc --}}
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
                                <div class="px-7 py-5">
                                    <div class="fs-4 text-dark fw-bolder">Tuỳ chọn</div>
                                </div>
                                <div class="separator border-gray-200"></div>
                                <div class="px-7 py-5">
                                    {{-- Chọn toà nhà --}}
                                    <div class="mb-10">
                                        <label class="form-label fs-5 fw-bold mb-3">Toà nhà:</label>
                                        <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-customer-table-filter="month" data-dropdown-parent="#kt-toolbar-filter">
                                            <option></option>
                                            <option value="aug">Toà A1</option>
                                            <option value="sep">Toà A2</option>
                                        </select>
                                    </div>
                                    <div class="mb-10">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Thêm cư dân</button>
                        </div>
                        {{-- Xoá khi chọn --}}
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-customer-table-toolbar="selected">
                            <div class="fw-bolder me-5">Đã chọn
                            <span class="me-2" data-kt-customer-table-select="selected_count"></span></div>
                            <button type="button" class="btn btn-danger" data-kt-customer-table-select="delete_selected">Xoá cư dân</button>
                        </div>
                    </div>
                </div>
                {{-- Bảng danh sách --}}
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Toà nhà</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            <tr>
                                ...
                                <td>0321325125</td>
                                <td data-filter="mastercard">Toà A1</td>
                                <td>P1245</td>
                                <td>14 Dec 2020</td>
                                <td>Kích hoạt</td>
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <div class="menu-item text-center">
                                            {{-- <a href="../../demo1/dist/apps/customers/view.html" class="menu-link px-3">Tạo tài khoản</a> --}}
                                            <a href="../../demo1/dist/apps/customers/view.html" class="menu-link px-3 text-center">Reset password</a>
                                        </div>
                                        <div class="menu-item ">
                                            <a href="#" class="menu-link px-3 text-center" data-kt-customer-table-filter="delete_row">Xoá</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>Melody Macy</td>
                                <td>melody@altbox.com</td>
                                <td>0386521452</td>
                                <td data-filter="visa">Toà A2</td>
                                <td>P1546</td>
                                <td>01 Dec 2020</td>
                                <td>Không</td>
                                <td class="text-end">
