    ...
    <div class="container">
        ...
        <div class="header-content position-relative d-flex align-items-center justify-content-between">
            <div class="back-button">
                <a href="@yield('back')">
                    <svg class="bi bi-arrow-left-short text-danger" width="32" height="32" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="setting-trigger-btn d-none" id="settingTriggerBtn">
