                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end align-items-center d-none"
                                ...
                                <div class="fw-bolder me-5">Đã chọn
                                    <span class="me-2" data-kt-subscription-table-select="selected_count"></span>
                                </div>
                                <button type="button" class="btn btn-danger"
                                    data-kt-subscription-table-select="delete_selected">Xoá</button>
                            </div>
                        </div>
                    </div>
...
@push('js')
    ...
    <script src="{{ url('/') }}public/assets/js/custom/building/list/export.js"></script>
